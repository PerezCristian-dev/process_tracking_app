...
export const ProcessItem = ({
  ...
  const { id, procedimiento, codigo, reclamado, diferencia, autorizado } =
    procedimientos;
      ...
      <div className="item__container">
        ...
        <span className="item__header">
          ...
          <input
            ...
            onBlur={handleBlur}
          />
          {procedimiento === "" && isBlur.procedimiento && (
        ...
        <span className="item__header">
          ...
          <input
            ...
            onBlur={handleBlur}
          />
          {reclamado === "" && isBlur.procedimiento && (
            <span className="validation">*Required</span>
          )}
        </span>
        <span className="item__header">
          ...
          <input
            ...
            onBlur={handleBlur}
          />
          {diferencia === "" && isBlur.procedimiento && (
            <span className="validation">*Required</span>
          )}
        </span>
        <span className="item__header">
          ...
          <input
            ...
            onBlur={handleBlur}
          />
          {autorizado === "" && isBlur.procedimiento && (
            <span className="validation">*Required</span>
          )}
        </span>
      </div>
